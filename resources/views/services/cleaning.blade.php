            ...
            <div class="row">
               <div class="col-md-6">
                 ...
                 <!--ten cuidado con las direcciones de las imagenes-->
                  ...
                  <div><img src="images/cleaning/cl_lf_1.png" class="services_img2"></div>
                  <!--Si vas a acomodar imagenes de otras formas crea otra clase para esa configuracion para no alterar todas las demas -->
               </div>
               <!--2da imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_rg_1.png" class="services_img2"></div>
                  
               </div>
               <!--3er imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_lf_2.png" class="services_img2"></div>
                 
               </div>
               <!--4ta imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_rg_2.png" class="services_img2"></div>
                 
               </div>
               <!--5ta imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_lf_3.png" class="services_img2"></div>
                 
               </div>
               <!--6ta imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_rg_3.png" class="services_img2"></div>
                 
               </div>
               <!--5ta imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_lf_4.png" class="services_img2"></div>
                 
               </div>
               <!--6ta imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_rg_4.png" class="services_img2"></div>
                 
               </div>
               <!--5ta imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_lf_5.png" class="services_img2"></div>
                 
               </div>
               <!--6ta imagen-->
               <div class="col-md-6">
                  <div><img src="images/cleaning/cl_rg_5.png" class="services_img2"></div>
